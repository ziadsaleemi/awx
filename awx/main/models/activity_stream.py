...
class ActivityStream(models.Model):
    ...
    quay_image_build_template = models.ManyToManyField("QuayImageBuildTemplate", blank=True)
    quay_image_build_job = models.ManyToManyField("QuayImageBuildJob", blank=True)
