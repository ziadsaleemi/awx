...
export function useManageSurveyQuestions(isJobTemplate: boolean, isTerraformTemplate?: boolean) {
  ...
  const endpoint = awxAPI`/${resourcePath}/${params.id?.toString() ?? ''}/survey_spec/`;
