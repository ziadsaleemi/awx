...
export function TerraformTemplateAddTeams() {
  ...
  const onSubmit = async (data: WizardFormValues) => {
    ...
    return new Promise<void>((resolve) => {
      teamRoleProgressDialog({
        ...
        onClose: () => {
          pageNavigate(AwxRoute.TerraformTemplateTeamAccess, {
    ...
    <PageLayout>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          {
            label: t('Team Access'),
            to: getPageUrl(AwxRoute.TerraformTemplateTeamAccess, { params: { id: template?.id } }),
          },
          { label: t('Add roles') },
        ]}
      />
      <PageWizard<WizardFormValues>
        ...
        disableGrid
        onCancel={() => {
          pageNavigate(AwxRoute.TerraformTemplateTeamAccess, { params: { id: template?.id } });
        }}
      />
    </PageLayout>
  );
