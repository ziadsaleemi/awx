export enum AwxRoute {
  ...
  CreateQuayImageBuildTemplate = 'awx-create-quay-image-build-template',
  EditQuayImageBuildTemplate = 'awx-edit-quay-image-build-template',
  QuayImageBuildTemplatePage = 'awx-quay-image-build-template-page',
  QuayImageBuildTemplateDetails = 'awx-quay-image-build-template-details',
  QuayImageBuildTemplateTeamAccess = 'awx-quay-image-build-template-team-access',
  QuayImageBuildTemplateUserAccess = 'awx-quay-image-build-template-user-access',
  QuayImageBuildTemplateJobs = 'awx-quay-image-build-template-jobs',
  QuayImageBuildTemplateNotifications = 'awx-quay-image-build-template-notifications',
  QuayImageBuildTemplateSchedules = 'awx-quay-image-build-template-schedules',
  QuayImageBuildTemplateTags = 'awx-quay-image-build-template-tags',
