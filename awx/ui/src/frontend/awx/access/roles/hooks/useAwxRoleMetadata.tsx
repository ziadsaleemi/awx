      ...
      content_types: {
        ...
        'shared.organization': {
          ...
          permissions: {
            ...
            'shared.view_edaactivation': t('View EDA activations'),
            'shared.execute_edaactivation': t('Operate EDA activations'),
            'shared.change_edaactivation': t('Manage EDA activations'),
            'shared.view_airesourceaction': t('View AI resource actions'),
            'shared.change_airesourceaction': t('Author AI resource actions'),
            'shared.approve_airesourceaction': t('Approve AI resource actions'),
