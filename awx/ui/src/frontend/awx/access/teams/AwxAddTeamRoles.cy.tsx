...
describe('Capstan team: Add roles', () => {
  const component = <AwxAddTeamRoles />;
  ...
  beforeEach(() => {
    ...
    cy.intercept('GET', awxAPI`/role_definitions/?content_type__model=project*`, {
      fixture: 'awxProjectRoles.json',
    });
  ...
  it('should display selected resources and roles in the Review step', () => {
    ...
    cy.get('[data-cy="expandable-section-awxRoles"]').should('contain.text', 'Project Admin');
