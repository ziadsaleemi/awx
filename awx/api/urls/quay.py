...
quay_urls = [
    ...
    re_path(
        r'^execution-environment-images/templates/(?P<pk>[0-9]+)/jobs/$',
        QuayImageBuildTemplateJobsList.as_view(),
        name='quay_image_build_template_jobs_list',
    ),
    re_path(
    ...
    re_path(
        ...
        QuayImageBuildTemplateNotificationTemplatesStartedList.as_view(),
        name='quay_image_build_template_notification_templates_started',
    ),
    re_path(
        r'^execution-environment-images/templates/(?P<pk>[0-9]+)/notification_templates_error/$',
        QuayImageBuildTemplateNotificationTemplatesErrorList.as_view(),
        name='quay_image_build_template_notification_templates_error',
    ),
    re_path(
        r'^execution-environment-images/templates/(?P<pk>[0-9]+)/notification_templates_success/$',
        QuayImageBuildTemplateNotificationTemplatesSuccessList.as_view(),
        name='quay_image_build_template_notification_templates_success',
    ),
    re_path(
        r'^execution-environment-images/templates/(?P<pk>[0-9]+)/object_roles/$',
        QuayImageBuildTemplateObjectRolesList.as_view(),
        name='quay_image_build_template_object_roles',
    ),
    re_path(
        r'^execution-environment-images/jobs/$',
        QuayImageBuildJobList.as_view(),
        name='quay_image_build_job_list',
    ),
    re_path(
        r'^execution-environment-images/jobs/(?P<pk>[0-9]+)/$',
        QuayImageBuildJobDetail.as_view(),
        name='quay_image_build_job_detail',
    ),
    re_path(
        r'^execution-environment-images/jobs/(?P<pk>[0-9]+)/cancel/$',
        QuayImageBuildJobCancel.as_view(),
        name='quay_image_build_job_cancel',
    ),
    re_path(
