...
class UnifiedJobSerializer(BaseSerializer):
    ...
    def get_field_names(self, declared_fields, info):
        field_names = super(UnifiedJobSerializer, self).get_field_names(declared_fields, info)
        if 'artifacts' not in field_names:
            field_names = tuple(field_names) + ('artifacts',)
        return field_names
    ...
    def get_artifacts(self, obj):
        if obj and hasattr(obj, 'display_artifacts'):
...
class TerraformJobTemplateSerializer(UnifiedJobTemplateSerializer):
    ...
    def get_summary_fields(self, obj):
        ...
        if obj.target_inventory_id:
            summary_fields['target_inventory'] = {
                'id': obj.target_inventory_id,
