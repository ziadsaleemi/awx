...
GLOBAL_JOB_EXECUTION_ENVIRONMENTS = [{'name': 'Capstan EE (latest)', 'image': 'quay.io/ansible/awx-ee:latest'}]
...
# Do not want Capstan to ask interactive questions and want it to be friendly with
# reprovisioning
...
#
# Optionally, Capstan can generate DOT graphs
...
# Connect to other Capstan nodes using http or https
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Capstan API',
    'DESCRIPTION': 'Capstan API Documentation',
    'VERSION': 'v2',
...
# Use Capstan base view, to give 401 on unauthenticated requests
...
OPA_POLICY_BUNDLE = ''  # Optional Rego policy bundle text stored in Capstan settings for admin-managed policy-as-code workflows.
...
AI_SYSTEM_PROMPT = (
    'You are a Capstan automation assistant. Help users understand and manage their '
    'automation resources, including job templates, inventories, '
