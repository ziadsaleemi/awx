...
| G1b | **Playbook / task coding assistant** — AI-generated extra-vars/Terraform variable suggestions are inline, and AI resource actions can now author survey specs/questions for job, workflow, and Terraform templates; project-backed playbook/role file generation is still incomplete | High | 🔄 |
...
| AP13 | **G1b was over-marked done** — `AICodeAssistant` is wired into Job Template extra variables and Terraform variables, and `/api/v2/ai/resource_actions/` now authors survey questions/specs for job, workflow, and Terraform templates; project-backed playbook/role file generation is not implemented | Documentation Drift | High | 🔄 |
