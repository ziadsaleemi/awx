...
| AP67 | **AI end-to-end resource creation proof is still missing** — From the AWX UI assistant, create and apply a playbook, role, inventory, smart inventory, and job template plan; verify serializer/RBAC/OPA validation, same-plan references, Activity Stream audit links, created resources, launch wiring, and rollback behavior for each resource class | Live Proof / AI | High | ⬜ |
