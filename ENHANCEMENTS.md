...
| I2 | **AI resource creation coverage** — support create/update plans for projects, job templates, workflow job templates, inventories, smart inventories, constructed inventories, inventory sources, schedules, credential references, catalog items, role assignments, and survey specs/questions without bypassing existing AWX permissions; backend coverage now includes projects, job templates, workflow job templates, inventories, smart inventories, constructed inventories, inventory sources, schedules, credential references for job templates, inventory sources, schedule launch prompts, and workflow-node launch prompts, role assignments for users/teams on object roles, catalog items, and survey spec replace/merge for job, workflow, and Terraform templates | High | 🔄 |
...
| AP15 | **AI resource creation is not end-to-end** — typed backend plan/preview/apply now exists for projects, project files/playbooks/roles, job templates, workflow job templates, inventories, smart inventories, constructed inventories, inventory sources, schedules, credential references for job templates, inventory sources, schedule launch prompts, and workflow-node launch prompts, user/team role assignments on object roles, catalog items, and survey specs/questions through `/api/v2/ai/resource_actions/`; the masthead assistant plus create/edit/detail contextual launcher expose frontend preview/apply approval paths, while workflow visualizer apply remains tracked separately in I6/AP14 | Stub / Approximation | High | 🔄 |
