...
| G1b | **Playbook / task coding assistant** — AI-generated extra-vars/Terraform variable suggestions are inline; AI resource actions can author survey specs/questions for job, workflow, and Terraform templates and now write playbook/role text files into existing manual Projects before creating Job Templates that point at those files; new Project workspace creation/ref wiring still needs the next pass | High | 🔄 |
...
| AP13 | **G1b was over-marked done** — `AICodeAssistant` is wired into Job Template extra variables and Terraform variables, `/api/v2/ai/resource_actions/` authors survey questions/specs for job, workflow, and Terraform templates, and AI can now write playbook/role files into existing manual Projects before creating Job Templates that reference them; creation of new AI-owned Project workspaces and generated Project references remains incomplete | Documentation Drift | High | 🔄 |
